...
var objectsArray = ["date/time", "city", "state", "country", "shape", "comment"];
...
var firstLetter = objectsArray[0];
var secondLetter = objectsArray[1];
console.log(firstObject);
console.log(secondObject);


// Use push() to append an item to an array
lettersArray.push("date/time");
lettersArray.push("city");
lettersArray.push("state");
lettersArray.push("country");
lettersArray.push("shape");
lettersArray.push("comment");
